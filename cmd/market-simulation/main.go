...
import (
	...
	pb "github.com/fynnwu/FinancialTrading/go-api/market-simulation"
	"github.com/fynnwu/FinancialTrading/internal/market-simulation/application"
	"github.com/fynnwu/FinancialTrading/internal/market-simulation/infrastructure"
	"github.com/fynnwu/FinancialTrading/internal/market-simulation/interfaces"
...
func main() {
	// 1. 加载配置
	configPath := "configs/market-simulation/config.toml"
	...
	logger.Info(ctx, "Starting MarketSimulationService", "version", cfg.Version)
	...
	s.GracefulStop()
	// gormDB.Close() // Close DB connection - removed as gormDB.DB is *gorm.DB which doesn't have Close() directly, and sqlDB is not exposed easily here without getting it. GORM handles connection pool.
