...
func registerGRPC(s *grpc.Server, srv any) {
	ctx := srv.(*AppContext)
	pb.RegisterReferenceDataServiceServer(s, grpchandler.NewGRPCHandler(ctx.AppService))
}
...
func initService(cfg any, m *metrics.Metrics) (any, func(), error) {
	...
	// 3. 仓储与服务装配
	bootLog.Info("initializing reference data service...")
