...
import (
	...
	executionhttp "github.com/wyfcoding/financialtrading/internal/execution/interfaces/http"
...
const IdempotencyPrefix = "execution:idem"
...
func registerGRPC(s *grpc.Server, svc any) {
	ctx := svc.(*AppContext)
	pb.RegisterExecutionServiceServer(s, executiongrpc.NewGRPCHandler(ctx.Execution))
}
...
func initService(cfg any, m *metrics.Metrics) (any, func(), error) {
	...
	executionRepo := mysql.NewExecutionRepository(db)
