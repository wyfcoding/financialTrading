...
import (
	...
	accountgrpc "github.com/wyfcoding/financialtrading/internal/account/interfaces/grpc"
	accounthttp "github.com/wyfcoding/financialtrading/internal/account/interfaces/http"
...
const IdempotencyPrefix = "account:idem"
...
func registerGRPC(s *grpc.Server, svc any) {
	ctx := svc.(*AppContext)
	pb.RegisterAccountServiceServer(s, accountgrpc.NewGRPCHandler(ctx.Account))
}
...
func initService(cfg any, m *metrics.Metrics) (any, func(), error) {
	...
	accountService := application.NewAccountService(accountRepo, transactionRepo, outboxMgr, db.RawDB())
