...
import (
	...
	"github.com/fynnwu/FinancialTrading/internal/matching-engine/infrastructure/repository"
	"github.com/fynnwu/FinancialTrading/internal/matching-engine/interfaces"
...
func main() {
	...
	logger.Info("Starting MatchingEngineService",
	...
	logger.Info("Shutting down MatchingEngineService")
	...
	logger.Info("MatchingEngineService stopped")
}
