...
import (
	...
	"github.com/fynnwu/FinancialTrading/internal/order/infrastructure/repository"
	"github.com/fynnwu/FinancialTrading/internal/order/interfaces"
...
func createGRPCServer(cfg *config.Config, orderAppService *application.OrderApplicationService) *grpc.Server {
	...
	// 注册服务
	handler := interfaces.NewGRPCHandler(orderAppService)
