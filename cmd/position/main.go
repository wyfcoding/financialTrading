...
import (
	...
	positiongrpc "github.com/wyfcoding/financialtrading/internal/position/interfaces/grpc"
	positionhttp "github.com/wyfcoding/financialtrading/internal/position/interfaces/http"
...
const IdempotencyPrefix = "position:idem"
...
func registerGRPC(s *grpc.Server, svc any) {
	ctx := svc.(*AppContext)
	pb.RegisterPositionServiceServer(s, positiongrpc.NewGRPCHandler(ctx.Position))
}
