...
import (
	...
	"github.com/fynnwu/FinancialTrading/internal/risk/infrastructure/repository"
	"github.com/fynnwu/FinancialTrading/internal/risk/interfaces"
...
func createGRPCServer(cfg *config.Config, riskAppService *application.RiskApplicationService) *grpc.Server {
	...
	// 注册服务
	handler := interfaces.NewGRPCHandler(riskAppService)
