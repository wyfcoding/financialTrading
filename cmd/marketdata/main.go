...
import (
	...
	httphandler "github.com/wyfcoding/financialtrading/internal/marketdata/interfaces/http"
...
func registerGRPC(s *grpc.Server, srv any) {
	ctx := srv.(*AppContext)
	pb.RegisterMarketDataServiceServer(s, grpchandler.NewMarketDataHandler(ctx.AppService))
}
...
func initService(cfg any, m *metrics.Metrics) (any, func(), error) {
	...
	// 3. 仓储与服务装配
	bootLog.Info("initializing market data service...")
