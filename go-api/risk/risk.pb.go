...
type RiskMetricsResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// 95% 在险价值。
	Var_95 string `protobuf:"bytes,1,opt,name=var_95,json=var95,proto3" json:"var_95,omitempty"`
	// 99% 在险价值。
...
const file_risk_risk_proto_rawDesc = "" +
	"\n" +
	"\x0frisk/risk.proto\x12\x04risk\"\x8a\x01\n" +
...
var file_risk_risk_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
