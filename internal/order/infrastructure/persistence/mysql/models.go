...
type OrderModel struct {
	...
	TakeProfitPrice float64 `gorm:"column:take_profit_price;type:decimal(20,8)"`
	...
	OcoOrderID      string  `gorm:"column:oco_order_id;type:varchar(36);index"`
